...
- 23-09-2026 · Skill `frontend-craft` rehecho sobre el brief (sin Klein, sombras, radios ni blur; sin `references/`, lee los archivos reales). Los otros tres skills visuales llevan nota de derogación de su capa visual al principio.
